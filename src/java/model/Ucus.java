...
public class Flight {
    ...
    public Flight(int flight_id, String flight_date, String flight_hour, String flight_time, double flight_fare, String company_name, String ucak_name, String ucus_departure, String ucus_arrival) {
        this.flight_id = flight_id;
        this.flight_date = flight_date;
        this.flight_hour = flight_hour;
        this.flight_time = flight_time;
